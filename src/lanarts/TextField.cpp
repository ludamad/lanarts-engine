...
static char keycode_to_char(int keycode, int keymod) {
...
void TextField::handle_key_up(int keycode, int keymod) {
    _current_mod = keymod;
...
bool TextField::handle_key_down(int keycode, int keymod) {
    _current_mod = keymod;
